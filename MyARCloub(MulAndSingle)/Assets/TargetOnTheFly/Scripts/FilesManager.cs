...
public class FilesManager : MonoBehaviour
{
	...
	public void ClearMarkNameList()
	{
		if(WWWTransport.imageNameList != null){
			WWWTransport.imageNameList.Clear ();
			Debug.Log ("ddms:清除后imageNameList长度: " + WWWTransport.imageNameList.Count);
		}
	}
